...
class ElevenLabsManager:
    ...
    def text_to_audio(self, input_text, voice="Nicole", save_as_wave=True, subdirectory=""):
    ...
    def text_to_audio_played(self, input_text, voice="Nicole"):
        audio = generate(
          text=input_text,
          voice=voice,
          model="eleven_monolingual_v1"
    ...
    def text_to_audio_streamed(self, input_text, voice="Nicole"):
